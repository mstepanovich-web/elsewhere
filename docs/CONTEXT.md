...
Last updated: 2026-05-27 (catch-up to Phase-2 close + Phase-3 / Plan B Stage A1+A2 ship. Phase 1 closed 2026-05-23; Phase 2 — the cross-app venue abstraction — closed 2026-05-24 (`docs/PHASE-2-BUILD-SPEC.md` at revision 3; db/032 + generalized `shell/venue-settings.js` + new `shell/venue-registry.js`, all shipped dormant). Phase 3 in progress under Plan B (`docs/VENUE-ADMIN-UI-DIRECTION.md` 2026-05-26 revision): Stage A1 (admin UI skeleton + db/034) and Stage A2 (audio renderer + db/035 + 19-venue audio seed) shipped per `docs/VENUE-ADMIN-UI-A1-BUILD-SPEC.md` §7. See "Current state" → "Latest shipped" + "Other context".)
...
### Other context
- Migrations applied to prod since last CONTEXT update: db/024 (2026-05-19), db/025 (2026-05-21), db/026–db/031 (2026-05-22 → 2026-05-23, closing Phase 1), db/032 (2026-05-24, opening Phase 2), db/034 + db/035 (2026-05-26, Phase-3 Plan-B Stages A1+A2). **No db/033** — the counter jumps 032 → 034; the gap is deliberate. Tracker current at `db/MIGRATIONS_APPLIED.md`.
